...
import { ArrowRight, Terminal, Zap, GitBranch, Shield, BarChart3, Code2, Network, CheckCircle2, ChevronRight, Users, Database, Activity, Sparkles, KeyRound, Info, ExternalLink, Monitor, Package, Download } from 'lucide-react';
